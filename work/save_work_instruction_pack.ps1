# Save instruction_pack via Work clone gateway
...
# Build JSON manually to preserve em dash encoding
$body = @"
{
  "gw_action": "artifact.save",
  "gw_workspace_id": "635bb8d7-7b93-4bea-8ca6-ee2c924c9557",
  "artifact_type": "instruction_pack",
  "title": "Instruction Pack \u2014 Qwrk@Work Gateway Operations v1",
  "priority": 3,
  "tags": ["instruction-pack", "gateway", "reference", "work", "v1"],
  "extension": {
    "scope": "Gateway mechanics reference for Qwrk@Work",
    "active": true,
    "priority": 1,
    "pack_format": "v1",
    "payload": {
...
Write-Host "=== SAVE: Instruction Pack via Work Clone ===" -ForegroundColor Cyan
