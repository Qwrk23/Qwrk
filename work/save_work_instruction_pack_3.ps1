...
$body = @"
{
  ...
  "title": "Instruction Pack - Qwrk@Work Cognitive Protocol v1",
  "priority": 3,
  "tags": ["instruction-pack", "cognitive", "adhd", "work", "v1"],
  "extension": {
    "scope": "Behavioral and cognitive operating rules for Qwrk@Work",
    "active": true,
    "priority": 1,
    "pack_format": "v1",
    "payload": {
...
Write-Host "=== SAVE: Instruction Pack #3 (Cognitive Protocol) ===" -ForegroundColor Cyan
