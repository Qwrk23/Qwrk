...
```json
{"gw_action":"artifact.list","gw_workspace_id":"635bb8d7-7b93-4bea-8ca6-ee2c924c9557","artifact_type":"project","selector":{"limit":20,"filters":{"tags_any":["email"]}}}
```
...
```json
{"gw_action":"artifact.list","gw_workspace_id":"635bb8d7-7b93-4bea-8ca6-ee2c924c9557","artifact_type":"project","selector":{"limit":20,"filters":{"tags_any":["messaging"]}}}
```
...
```json
{"gw_action":"artifact.list","gw_workspace_id":"635bb8d7-7b93-4bea-8ca6-ee2c924c9557","artifact_type":"journal","selector":{"limit":20,"filters":{"tags_any":["email","calendar"]}}}
```
...
```json
{"gw_action":"artifact.list","gw_workspace_id":"635bb8d7-7b93-4bea-8ca6-ee2c924c9557","artifact_type":"branch","selector":{"limit":20,"parent_artifact_id":"dec0597b-8edc-4387-95e7-025960f3cedc"}}
```
...
Hydrate both:
```json
{"gw_action":"artifact.query","gw_workspace_id":"635bb8d7-7b93-4bea-8ca6-ee2c924c9557","artifact_type":"project","artifact_id":"3f3f9725-5761-4a47-8c9e-920b8a18a1bf","selector":{"hydrate":true}}
```
```json
{"gw_action":"artifact.query","gw_workspace_id":"635bb8d7-7b93-4bea-8ca6-ee2c924c9557","artifact_type":"project","artifact_id":"88944802-5097-4761-8844-523c1af0c109","selector":{"hydrate":true}}
```
