...
```json
{
  ...
  "gw_workspace_id": "970d0df8-ab84-47f5-926c-3e784ba5dfa2",
...
```json
"to": ["greg@example.com", "someone@example.com"]
```
...
*CHANGELOG: ACTIVE (2026-03-30): Introduced ACTIVE alias pattern. Greg workspace adaptation from Prime v2.2. Workspace ID: `970d0df8-ab84-47f5-926c-3e784ba5dfa2`. Filename is now the stable entry point referenced by Instruction Pack Index — on version bump, this file is archived via Pattern C and replaced with updated content.*
