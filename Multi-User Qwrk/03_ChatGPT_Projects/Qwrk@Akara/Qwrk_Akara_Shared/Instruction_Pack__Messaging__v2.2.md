# Instruction Pack: Messaging v2.2
...
*CHANGELOG: v2.2 (2026-03-21): Akara workspace adaptation from Prime Messaging IP v2.2. Workspace ID, signature, and examples adapted. Full feature parity with Prime messaging capability.*
