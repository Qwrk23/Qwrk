...
```json
{
  ...
  "gw_workspace_id": "b4e7f648-96d5-44a7-80b9-c39cac4efbd1",
  "to": ["recipient@example.com"],
  "subject": "BlaggLife Update",
  "body_html": "<p>Hi there,</p><p>Here is your update from <strong>BlaggLife</strong>.</p><p>Thank you,<br>Joel</p><p>—<br>Sent via Qwrk Messaging Subsystem</p>",
  "body_text": "Hi there,\n\nHere is your update from BlaggLife.\n\nThank you,\nJoel\n\n—\nSent via Qwrk Messaging Subsystem"
}
```
...
*CHANGELOG: ACTIVE (2026-03-30): Introduced ACTIVE alias pattern. Content identical to BlaggLife v2.2. Filename is now the stable entry point referenced by Instruction Pack Index — on version bump, this file is archived via Pattern C and replaced with updated content. Prior version: `instruction_pack_messaging_v_2_2.md` (v2.2-blagglife). v2.2-blagglife (2026-03-12): BlaggLife workspace adaptation from Prime v2.2.*
