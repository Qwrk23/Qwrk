# ⚠️ SUPERSEDED — Qwrk Beta Signup + NDA (Manual Tracking) — v1 (2026-01-02)

> **SUPERSEDED NOTICE**
> **Artifact ID**: `5708a92e-6448-4493-8ff0-f7f614ed7dca`
> **Status**: Superseded (2026-01-02)
> **Replaced By**: Restart — People Intake: "Signup + NDA" (MVP) (artifact: `a4b0bfd5-147a-4b5e-b43b-e3f220f4f681`)
> **Canonical Documentation**: `AAA_New_Qwrk__Restart__People_Intake_Signup_NDA_MVP__2026-01-02__v1.md`

**This record has been formally superseded in the Qwrk database and should not be used as the current source of truth.**

**Use the canonical Restart instead:**
- File: `AAA_New_Qwrk__Restart__People_Intake_Signup_NDA_MVP__2026-01-02__v1.md`
...
- Owner: Master Joel
- Date: 2026-01-02
- Status: SUPERSEDED (replaced by artifact `a4b0bfd5-147a-4b5e-b43b-e3f220f4f681`)

---

## SUPERSEDED NOTICE (Repeated for Clarity)

**This document is preserved for historical reference only.**

**DO NOT use this as the current specification.**

**Current canonical Restart:**
- File: `AAA_New_Qwrk__Restart__People_Intake_Signup_NDA_MVP__2026-01-02__v1.md`
- Artifact ID: `a4b0bfd5-147a-4b5e-b43b-e3f220f4f681`
