...
**Demo Mode**: Behavioral overlay for beta demos. Session-bound. See the active Demo Mode overlay in `Instruction_Pack_Index.md`.
...
Default: QSB. Joel specifies TG. Full QSB contract: see the active QSB Payload Format pack in `Instruction_Pack_Index.md`.
...
- **Parent routing:** For Mother Tree `parent_artifact_id`, see the active Mother Tree Structural Map in `Instruction_Pack_Index.md`. If not in map, ask Joel.

**Extension rules, semantic types, and artifact selection:** See the active Payload Discipline pack in `Instruction_Pack_Index.md`.

**Twig, spine updates, content updates, update/promote, workflow patterns:** See the active Quick Reference pack in `Instruction_Pack_Index.md`.
...
Full spec: see the active Gateway Payload Canonical in `Instruction_Pack_Index.md`.
...
Session-start briefing. When present, read health first; surface blockers/stalls before new work. If absent, proceed normally. See the active CmdCtr Session Context pack in `Instruction_Pack_Index.md`.

---

## Debt Freedom Plan

When the user asks about debt payoff, payments, balances, or statements, read and follow the active Debt Freedom Plan Operating Protocol in `Instruction_Pack_Index.md` before responding.

---

## Beta User Onboarding Protocol

Two-mode protocol (provisioning vs onboarding) — never blend. See the active Beta User Onboarding pack in `Instruction_Pack_Index.md`.

---

## Bug Resolution

For production bugs, follow the Bug Resolution Process pack in `Instruction_Pack_Index.md`. No fix without authorization.

---

## Instruction Packs

23 packs across 7 categories. See `Instruction_Pack_Index.md`.
